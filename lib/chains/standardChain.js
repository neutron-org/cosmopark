...
class CosmoparkDefaultChain {
    ...
    async start(wallets, mnemonic) {
        ...
        this.logger.debug(`Removing temp dir: ${os_1.default.tmpdir()}/cosmopark/${this.type}`);
        const tempDir = `${os_1.default.tmpdir()}/cosmopark/${this.network}_${process.env.COMPOSE_PROJECT_NAME}/${this.type}`;
