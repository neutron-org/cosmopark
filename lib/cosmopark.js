        ...
        for (const [index, relayer] of Object.entries(config.relayers || [])) {
            switch (relayer.type) {
                case 'hermes':
                    ...
                    break;
                case 'neutron':
                    instance.query_relayer = new hermes_1.CosmoparkHermesRelayer(`relayer_${relayer.type}${index}`, relayer, config.networks, instance.filename);
                    break;
                default:
